 ...
 <div id="wrapper">
  ...
  <!--Start sidebar-wrapper-->
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li class="active">
        <a href="{{route('admin.CarBrandCreate')}}" clas="active">
          <i class="zmdi zmdi-view-dashboard"></i> <span>Dashboard</span>
        </a>
      </li>

      <li>
        <a href="{{route('admin.CarBrandIndex')}}">
          <i class="zmdi zmdi-invert-colors"></i> <span>ARABA MARKALARI</span>
        </a>
      </li>

      <li>
        <a href="{{route('admin.CarBrandCreate')}}">
          <i class="zmdi zmdi-format-list-bulleted"></i> <span>Marka Oluştur</span>
        </a>
      </li>

      <li>
        <a href="">
          <i class="zmdi zmdi-grid"></i> <span>Marka Güncelleme Sayfası</span>
        </a>
      </li>
...
<div class="clearfix"></div>
 ...
 <!-- simplebar js -->
  ...
  <!-- loader scripts -->
  <script src="{{asset('/panel/assets/js/jquery.loading-indicator.js')}}"></script>
  <!-- Custom scripts -->
